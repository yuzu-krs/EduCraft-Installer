...
def start_download():
    try:
        ...
        downloads = [
            {
                "url": "https://github.com/yuzu-krs/EduCraft-Setup-v2/raw/refs/heads/main/EduCraft.jar",
                "save_path": os.path.join(os.getenv("APPDATA"), ".minecraft", "versions", "EduCraft", "EduCraft.jar")
            },
            {
                "url": "https://github.com/yuzu-krs/EduCraft-Setup-v2/raw/refs/heads/main/EduCraft.json",
                "save_path": os.path.join(os.getenv("APPDATA"), ".minecraft", "versions", "EduCraft", "EduCraft.json")
            },
            {
                "url": "https://github.com/yuzu-krs/EduCraft-Setup-v2/raw/refs/heads/main/EduCraft.zip",
                "save_path": os.path.join(os.getenv("APPDATA"), "EduCraft.zip")
            }
        ]
        ...
        if not cancel_flag.is_set():
            zip_file_path = os.path.join(os.getenv("APPDATA"), "EduCraft.zip")
            extract_zip(zip_file_path, "C:\\")
